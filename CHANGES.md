...
* 2026.09.30.1650 - Prompt/Context Engineering Lab Notes post. **2026-08-31** — Drafted at `lab-notes/prompt-and-context-engineering.html` using your opening reflection and all 9 subheadings; each section has a `[NEEDS YOUR EXAMPLE]` placeholder since no real examples were supplied yet (went with option (b) from the proposed solution). Added "Lab Notes" to site nav/footer on both pages. Commit: afae4ac.
