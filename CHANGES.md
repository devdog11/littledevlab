...
Recommendation is #1: it matches the CHANGES.md-as-approval-gate pattern already in place, and keeps you deciding what actually ships instead of an agent publishing on its own judgment. Say the word if you want it scheduled. Commit: (this push).
